...
const baseClassName =
  "min-w-[3rem] inline-flex items-center justify-center gap-2 rounded-md px-2 md:px-4 py-2 text-sm font-medium transition disabled:cursor-not-allowed disabled:opacity-50";
